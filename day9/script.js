...
// function search() {
//   const searchInput = document.querySelector('input[name="search-text"]').value;
...
// // const newHistory = youtubeHistory ? JSON.parse(youtubeHistory) : [];
// // if (videoId && !newHistory.includes(videoId)) {
...
//     return (
//       video.title.toLowerCase().includes(query) || // Check if title matches
//       video.author.toLowerCase().includes(query) // Check if author matches
//     );
//   });
